...
function Sub3Component(){
    ...
    const getProduct=()=>{
        ...
        axios({
            url: './data/shopping_product.json',
            method: 'GET'
        })
        .then((res)=>{
    ...
    return (
            ...
            <section id="section1">
                <div className="container">
                    <div className="gap">
                        ...
                        <div className="container">
                            <a href="!#" onClick={e => e.preventDefault()}><img src="./img/sub3/pPxVgfzLnWqHuN6KKV6OjVw2kPFAprlzbNrLRzuv.webp" alt=""/></a>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="right">
                                <div className="right-header">
                                    ...
                                    <span>
                                        ...
                                        <a href="!#" onClick={e => e.preventDefault()} className="order-btn on" title="혜택순">혜택순</a> <i>|</i>
                                                        ...
                                                        <div className="col-gap">
                                                            <a href="!#" onClick={e => e.preventDefault()}>
                                                                <div className="img-box">
                                                                    <img src={`./img/sub3/${item.상품이미지}`} alt=""/>
                                                                    <span><img src={`./img/sub3/${item.카트아이콘}`} alt=""/></span>
                                                                </div>
                                                                <div className="txt-box">
                                                                    ...
                                                                    {item.후기 !== "" ? <h5><span className= "sub3-review">후기 {item.후기}</span></h5> : ``}
                                                                    {item.판매처 !== "" ? <h4 className= "sub3-kurlyonly">{item.판매처}</h4> : ``}
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </li>
        ...
        <div className="sub3-modal1">
                <div className="container">
                    <div className="content">
                        ...
                        <ul>
                            <li><label htmlFor="sub3Modal-01"><input type="checkbox" id="sub3Modal-01" name="sub3_modal_01" value="과일·견과·쌀"/>과일·견과·쌀</label></li>
                            <li><label htmlFor="sub3Modal-02"><input type="checkbox" id="sub3Modal-02" name="sub3_modal_02" value="국·반찬·메인요리"/>국·반찬·메인요리</label></li>
                            <li><label htmlFor="sub3Modal-03"><input type="checkbox" id="sub3Modal-03" name="sub3_modal_03" value="면·양념·오일"/>면·양념·오일</label></li>
                            <li><label htmlFor="sub3Modal-04"><input type="checkbox" id="sub3Modal-04" name="sub3_modal_04" value="생활용품·리빙·캠핑"/>생활용품·리빙·캠핑</label></li>
                            <li><label htmlFor="sub3Modal-05"><input type="checkbox" id="sub3Modal-05" name="sub3_modal_05" value="샐러드·간편식"/>샐러드·간편식</label></li>
                            <li><label htmlFor="sub3Modal-06"><input type="checkbox" id="sub3Modal-06" name="sub3_modal_06" value="수산·해산·건어물"/>수산·해산·건어물</label></li>
                            <li><label htmlFor="sub3Modal-07"><input type="checkbox" id="sub3Modal-07" name="sub3_modal_07" value="정육·계란"/>정육·계란</label></li>
                            <li><label htmlFor="sub3Modal-08"><input type="checkbox" id="sub3Modal-08" name="sub3_modal_08" value="간식·과자·떡"/>간식·과자·떡</label></li>
                            <li><label htmlFor="sub3Modal-09"><input type="checkbox" id="sub3Modal-09" name="sub3_modal_09" value="생수·음료·우유·커피"/>생수·음료·우유·커피</label></li>
                            <li><label htmlFor="sub3Modal-10"><input type="checkbox" id="sub3Modal-10" name="sub3_modal_10" value="건강식품"/>건강식품</label></li>
                        </ul>
        ...
        {
            state2.isModal2 && (
            <div className="sub3-modal2">
                <div className="container">
                    <div className="content">
                        <div className="title">
                            <h2>브랜드</h2><a href="!#" onClick={e => e.preventDefault()} className="on">가나다 순</a><i>|</i><a href="!#" onClick={e => e.preventDefault()}>상품많은 순</a>
                        </div>
                        <ul>
                            <li><label htmlFor="sub3Modal2-01"><input type="checkbox" id="sub3Modal2-01" name="sub3_modal2_01" value="더반찬"/>더반찬</label></li>
                            <li><label htmlFor="sub3Modal2-02"><input type="checkbox" id="sub3Modal2-02" name="sub3_modal2_02" value="디어스킨"/>디어스킨</label></li>
                            <li><label htmlFor="sub3Modal2-03"><input type="checkbox" id="sub3Modal2-03" name="sub3_modal2_03" value="마마포레스트"/>마마포레스트</label></li>
                            <li><label htmlFor="sub3Modal2-04"><input type="checkbox" id="sub3Modal2-04" name="sub3_modal2_04" value="메종콜리브리"/>메종콜리브리</label></li>
                            <li><label htmlFor="sub3Modal2-05"><input type="checkbox" id="sub3Modal2-05" name="sub3_modal2_05" value="부보"/>부보</label></li>
                            <li><label htmlFor="sub3Modal2-06"><input type="checkbox" id="sub3Modal2-06" name="sub3_modal2_06" value="샐러드판다"/>샐러드판다</label></li>
                            <li><label htmlFor="sub3Modal2-07"><input type="checkbox" id="sub3Modal2-07" name="sub3_modal2_07" value="에코버"/>에코버</label></li>
                            <li><label htmlFor="sub3Modal2-08"><input type="checkbox" id="sub3Modal2-08" name="sub3_modal2_08" value="타르틴베이커리"/>타르틴베이커리</label></li>
                            <li><label htmlFor="sub3Modal2-09"><input type="checkbox" id="sub3Modal2-09" name="sub3_modal2_09" value="풀무원"/>풀무원</label></li>
                            <li><label htmlFor="sub3Modal2-10"><input type="checkbox" id="sub3Modal2-10" name="sub3_modal2_10" value="퓨어스펙"/>퓨어스펙</label></li>
                        </ul>
                        <div className="button-box">
                            <button className="format-btn"><svg width="12" height="12" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.78 3.96303C12.504 2.16973 10.4086 1 8.04 1C4.15192 1 1 4.15192 1 8.04C1 11.9281 4.15192 15.08 8.04 15.08C11.9281 15.08 15.08 11.9281 15.08 8.04" stroke="#ddd" strokeWidth="1.6" strokeLinecap="square" strokeLinejoin="round"></path><path d="M14.4933 1L14.4933 4.52H10.9733" stroke="#ddd" strokeWidth="1.6" strokeLinecap="square" strokeLinejoin="round"></path></svg>초기화</button>
                            <button className="ok-btn">확인</button>
