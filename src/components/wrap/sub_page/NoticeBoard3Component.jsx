...
function NoticeBoard3Component(){

    return (
        <main id="board" className="notice3">
            ...
            <section id="section1">
                <div className="container">
                    ...
                    <div className="right">
                        <h1 style={{fontSize: '50px', textAlign:'center', padding: '300px', background:'#f6f6f6'}}>1:1 문의</h1>
                    </div>
                </div>
            </section>
...
export default NoticeBoard3Component;